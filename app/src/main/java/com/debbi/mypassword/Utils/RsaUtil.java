...
//    public static void put(Contexttext ctx, String key, String value) {
...
//                Log.d("aaa", "publicKey = " + publicKey );
//                Log.d("aaa", "publicKey tostring = " + publicKey.toString() );
                // Encrypt the text
...
//                Log.d("aaa", "privateKey = " + privateKey );
//                Log.d("aaa", "privateKey tostring = " + privateKey );
    ...
    private static KeyStore.PrivateKeyEntry getPrivateKey(Context context) throws KeyStoreException,
        ...
        if (entry == null) {
            ...
            try {
                ...
                if (entry == null) {
                    Log.d(TAG, "Generating new key failed...");
                    return null;
                }
